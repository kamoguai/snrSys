                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: _autoTextSize("電話", TextStyle(color: Colors.grey), context),
                      ),
                      _buildHeightLine(),
                      Container(
                        width: (_deviceWidth9(context) * 2 + _deviceWidth9(context) * 0.75) - 1,
                        child: _autoTextSize("電話1", TextStyle(color: Colors.grey), context),
                      ),
                      _buildHeightLine(),
                      Container(
                        width: (_deviceWidth9(context) * 2 + _deviceWidth9(context) * 0.75) - 1,
                        child: _autoTextSize("電話2", TextStyle(color: Colors.grey), context),
                      ),
                      _buildHeightLine(),
                      Container(
                        width: _deviceWidth92(context) ,
                        child: _autoTextSize("電話3", TextStyle(color: Colors.grey), context),
                      ),
                    ],
                  )
                ),
