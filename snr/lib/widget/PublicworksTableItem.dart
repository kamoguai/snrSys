 ...
 * Date: 2019-04-22
 */
class PublicworksTableItem extends StatelessWidget {
  final PublicworksViewModel defaultViewModel;
  ...
  _deviceWidth925(context) {
    final deviceWidth = MediaQuery.of(context).size.width;
    var width9 =  deviceWidth / 9;
    return width9 + (width9 * 0.25);
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (typeValue == "1" || typeValue == "2") {
      wkNo = defaultViewModel.wkNo;
    }
    else {
      wkNo = defaultViewModel.n_COID;
      targetMan = defaultViewModel.target;
      yearM = defaultViewModel.yearMonth;
    }
    return Container(
        ...
        children: <Widget>[
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: _autoTextSize(defaultViewModel.saleMan,TextStyle(color: Colors.black), context),
                      ),
                    ],
                  )
                ),
                ...
                _autoContainer(
                  child: Row(
                    ...
                    children: <Widget>[
                      Container(
                        width: _deviceWidth3(context) - 1,
                        child: _autoTextSize(defaultViewModel.workInfo,TextStyle(color: Colors.black), context),
                      ),
                      _buildHeightLine(),
                      Container(
                        width: (_deviceWidth3(context) + _deviceWidth9(context) * 0.5) - 1,
                        child: _autoTextSize(defaultViewModel.workDate,TextStyle(color: Colors.black), context),
                      ),
                      _buildHeightLine(),
                      Container(
                        width: _deviceWidth92(context),
                        child: _autoTextSize(defaultViewModel.workMan,TextStyle(color: Colors.black), context),
                      ),
                    ],
                  ),
                )
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Row(
                    children: <Widget>[
                      Container(
                        width: (_deviceWidth9(context) + _deviceWidth9(context) * 0.5) - 1,
                      ...
                      Container(
                        ...
                        child: _autoTextSize(defaultViewModel.fixDate,
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                GestureDetector(
                  onTap: (){addTransform(custNo: defaultViewModel.custNo, workMan: defaultViewModel.workMan, wkNo: defaultViewModel.wkNo, n_coid: defaultViewModel.n_COID, target: defaultViewModel.target, yearMonth: defaultViewModel.yearMonth);},
                  child: Container(
                    color: _changeTransColor(),
          ...
          GestureDetector(
            child: Column(
              children: <Widget>[
                ...
                _buildLine(),
                _autoContainer_full(
                  child: _autoTextSize(defaultViewModel.bossLog, TextStyle(color:  Color(MyColors.hexFromStr(defaultViewModel.bossLogColor))), context),
                ),
                _buildLine(),
                _autoContainer_full(
...
class PublicworksViewModel {
  ...
  PublicworksViewModel();

  PublicworksViewModel.forMap(PublicworksTableCell data) {
    ...
    note7_color = data.note7_color == null ? "000000" : data.note7_color;
